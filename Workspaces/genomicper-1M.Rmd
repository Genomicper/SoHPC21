---
title: "Genomicper Notebook - 1M Use case"
...
profvis({
    ...
    all_data <- fread(file = "Data/AllData1M.tsv",data.table = FALSE)
...
## Comparsion of vroom vs fread - 1M use case
...
res <- microbenchmark(
                      vroom(file = "Data/AllData1M.tsv"),
                      fread(file = "Data/AllData1M.tsv"),
                      times = 20
                    )
...
gwas <- vroom(file = "Data/AllData1M.tsv")
tgwas <- fread(file = "Data/AllData1M.tsv")
object_size(gwas)   
object_size(tgwas)  
